...
OBJS = main.o log.o game.o canvas.o map.o assets.o animation.o scene_builder.o scene_path.o wordlist.o text_input.o placement.o unit.o ui.o enemy.o healthbar.o spawner.o projectile.o
